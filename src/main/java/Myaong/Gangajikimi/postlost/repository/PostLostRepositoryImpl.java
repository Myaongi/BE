...
public class PostLostRepositoryImpl implements PostLostRepositoryCustom {

        private final JPAQueryFactory queryFactory;
        private final QPostLost postLost = QPostLost.postLost;
        private final GeometryFactory geometryFactory;

        @Override
        public Page<PostLost> findPostLostByFilter (Pageable pageable,
        ...
        OrderSpecifier<?> decideOrderSpecifier (SortType sortType, NumberExpression < Double > distance){
            ...
            if (sortType == SortType.DISTANCE) {
                ...
                return postLost.createdAt.desc();
            }
        }
        ...
        BooleanExpression decideTimeFilter (TimeFilter timeFilter){
            ...
            return postLost.createdAt.goe(point);
